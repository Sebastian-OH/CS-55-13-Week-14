...
const dataURL = "https://dev-cs-55-13-site.pantheonsite.io/wp-json/twentytwentyone-child/v1/review/";

// function returns ids for all json objects in array
export async function otherIds() {
...
export async function otherSortedList() {
  // get filepath to json file
  // const filePath = path.join(dataDir, 'persons.json');
...
export async function otherData(idRequested) {
  // get filepath to json file
  // const filePath = path.join(dataDir, 'persons.json');
